...
Thank you for your interest in contributing to `aligator`.
...
Use the GitHub [issue tracker](https://github.com/Simple-Robotics/aligator/issues) to report bugs or suggest features.
...
Ask questions in the [discussions section](https://github.com/Simple-Robotics/aligator/discussions).
...
```
- CMake: require Eigen3 between 3.4.0 and major version 5 ([#390](https://github.com/Simple-Robotics/aligator/pull/390))
```
...
All contributions to this repository are under the BSD 3-Clause License, as stated in [LICENSE](../LICENSE).
